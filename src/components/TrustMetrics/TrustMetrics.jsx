    ...
    datasets: [
      {
        label: "Enabled",
        data: [
          dataTransparency.dataCollected.optOutOptions.personalizedAds
            ? 70
            : 30,
          dataTransparency.dataCollected.optOutOptions.activityTracking
            ? 60
            : 40,
          dataTransparency.dataCollected.optOutOptions.locationTracking
            ? 50
            : 50,
        ],
